...
ALARM_PATH := vendor/toxic/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/toxic/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/toxic/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/toxic/prebuilt/common/media/audio/ui
